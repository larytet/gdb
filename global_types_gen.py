...
#  ofd470 --dwarf_display=none,dinfo,types,nodaranges,nodabbrev --obj_display=none -g -o fw.txt image.out
#  ./global_types_gen.py -t fw.txt  -i /tmp/list --osh /tmp/fw.sh   
# Output of ofd470 looks like this
